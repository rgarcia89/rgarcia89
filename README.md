...
- [tuunit/oauth2-proxy-in-100-lines](https://github.com/tuunit/oauth2-proxy-in-100-lines) - A talk about how OAuth2 works and a demo on how to write a minimal OAuth2 Proxy in less than 100 lines of Go (3 days ago)
- [grafana-community/helm-charts](https://github.com/grafana-community/helm-charts) - Grafana Community Kubernetes Helm Charts (4 days ago)
...
- [thanos-community/helm-charts](https://github.com/thanos-community/helm-charts) - Community-Driven Thanos Charts 💪 (5 days ago)
- [backstage/software-templates](https://github.com/backstage/software-templates) - Backstage Software Templates for creating a new software component (6 days ago)
- [backstage/backstage](https://github.com/backstage/backstage) - Backstage is an open framework for building developer portals (6 days ago)
