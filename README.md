...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.12.0](https://github.com/kyverno/kyverno/releases/tag/v1.12.0), 1 day ago) - Kubernetes Native Policy Management
...
- [kubernetes-sigs/network-policy-api](https://github.com/kubernetes-sigs/network-policy-api) - This repo addresses further work involving Kubernetes network security beyond the initial NetworkPolicy resource (2 days ago)
