...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.12.0-alpha.4](https://github.com/kyverno/kyverno/releases/tag/v1.12.0-alpha.4), 3 days ago) - Kubernetes Native Policy Management
- [goharbor/harbor](https://github.com/goharbor/harbor) ([v2.9.3-rc1](https://github.com/goharbor/harbor/releases/tag/v2.9.3-rc1), 4 days ago) - An open source trusted cloud native registry project that stores, signs, and scans content.
...
- [grafana/grafana-operator](https://github.com/grafana/grafana-operator) - An operator for Grafana that installs and manages Grafana instances, Dashboards and Datasources through Kubernetes/OpenShift CRs (2 days ago)
