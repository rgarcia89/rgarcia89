...
- [kyverno/chainsaw](https://github.com/kyverno/chainsaw) - Declarative K8s e2e testing (2 days ago)
- [thanos-community/thanos-operator](https://github.com/thanos-community/thanos-operator) - WIP: Operator to manage Thanos installation (3 days ago)
- [Azure/kaito](https://github.com/Azure/kaito) - Kubernetes AI Toolchain Operator (5 days ago)
- [cncf/llm-in-action](https://github.com/cncf/llm-in-action) - 🤖 Discover how to apply your LLM app skills on Kubernetes! (5 days ago)
