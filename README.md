...
- [thanos-io/thanos](https://github.com/thanos-io/thanos) ([v0.33.0-rc.0](https://github.com/thanos-io/thanos/releases/tag/v0.33.0-rc.0), today) - Highly available Prometheus setup with long term storage capabilities. A CNCF Incubating project.
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.10.6](https://github.com/kyverno/kyverno/releases/tag/v1.10.6), today) - Kubernetes Native Policy Management
