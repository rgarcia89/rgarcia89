...
- [thanos-io/thanos](https://github.com/thanos-io/thanos) ([v0.32.0](https://github.com/thanos-io/thanos/releases/tag/v0.32.0), 5 days ago) - Highly available Prometheus setup with long term storage capabilities. A CNCF Incubating project.
...
- [elastic/terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) - Terraform provider for Elastic Stack (1 week ago)
